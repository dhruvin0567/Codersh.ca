          ...
          <ul className="list-unstyled">
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/woocommerce-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/shift-four-shop-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/prestashop-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/big-commerce-development"
                    ? "active-link"
                    : ""
                }
              >
          ...
          <ul className="list-unstyled">
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/wordpress-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/php-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/laravel-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/react-js-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/angular-js-development"
                    ? "active-link"
                    : ""
                }
              >
          ...
          <ul className="list-unstyled">
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/android-app-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/ios-app-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/hybrid-app-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/flutter-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/react-native-development"
                    ? "active-link"
                    : ""
                }
              >
          ...
          <ul className="list-unstyled">
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/wireframe-design"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/website-redesign"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/services/mobile-app-design"
                    ? "active-link"
                    : ""
                }
              >
