      ...
      <div className="row">
          ...
          <ul className="list-unstyled">
            <li className="mega-menu-item">
              <Link
                to="/customStore"
                className={
                  location.pathname === "/customStore" ? "active-link" : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/shopify-migrations"
                className={
                  location.pathname === "/shopify-migrations"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/headless-shopify"
                className={
                  location.pathname === "/headless-shopify" ? "active-link" : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/shopify-plus"
                className={
                  location.pathname === "/shopify-plus" ? "active-link" : ""
                }
              >
        ...
        <div className="col-12 col-md-6 col-lg-4">
          ...
          <ul className="list-unstyled">
            <li className="mega-menu-item">
              <Link
                to="/support-&-maintanance"
                className={
                  location.pathname === "/support-&-maintanance"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/conversion-rate"
                className={
                  location.pathname === "/conversion-rate" ? "active-link" : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/selling-internationally-on-shopify"
                className={
                  location.pathname === "/selling-internationally-on-shopify"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/subscriptions-on-shopify"
                className={
                  location.pathname === "/subscriptions-on-shopify"
                    ? "active-link"
                    : ""
                }
              >
        ...
        <div className="col-12 col-md-6 col-lg-4">
          ...
          <ul className="list-unstyled">
            <li className="mega-menu-item">
              <Link
                to="/email-marketing-agency"
                className={
                  location.pathname === "/email-marketing-agency"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                ...
                className={
                  location.pathname === "/shopify-app-development"
                    ? "active-link"
                    : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/seo-agency"
                className={
                  location.pathname === "/seo-agency" ? "active-link" : ""
                }
              >
            ...
            <li className="mega-menu-item">
              <Link
                to="/shopify-b2b-wholesale"
                className={
                  location.pathname === "/shopify-b2b-wholesale"
                    ? "active-link"
                    : ""
                }
              >
