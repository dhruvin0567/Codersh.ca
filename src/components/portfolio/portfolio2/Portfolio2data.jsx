function Portfolio2data() {
  return (
    <>
      <div className="project-cards-section mt-5 pt-5">
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj1.webp"
                  alt
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj2.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj3.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj4.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj5.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj6.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj7.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj8.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="portfolio-image-wrapper">
                <img
                  src="/src/assets/assets/Images/pj9.webp"
                  alt
                  className="portfolio-image"
                />
              </div>
