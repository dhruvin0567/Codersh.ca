...
const Section = memo(function Section({ img, alt, title, text, reverse, btnText, btnLink, isFirst }) {
    return (
        <div className={`section ${isFirst ? 'aximo-section-padding2' : 'aximo-section-padding6'}`}>
            <div className="container">
                <div className={`row d-flex ${reverse ? 'flex-row-reverse' : ''}`.trim()}>
