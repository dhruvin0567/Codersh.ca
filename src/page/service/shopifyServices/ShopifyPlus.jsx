...
const sections = [
  {
    img: ThumbImg1,
    title:
      "Trusted by Merchants for Expertise, Growth, and Data-Driven Innovation",
  ...
  },
  {
    img: ThumbImg2,
    title:
      "Unlock Your Business Potential with Advanced Shopify Plus Solutions",
        ...
        >
          <div className="container aximo-section-padding5 shopify-services-data">
            ...
            <p className="light-text">
              Empowering E-Commerce Growth from Concept to Expansion. As a
              Certified Shopify Plus Partner We Build, Develop, and Scale
          ...
          <div className="aximo-service-wrap">
            <div className="row">
              {services.map((item, index) => (
                <FadeInStagger key={item.id} index={index} className="col-12">
